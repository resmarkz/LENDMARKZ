    ...
    return (
        <ClientDashboardLayout>
            <div className="p-6 bg-white rounded-lg shadow-md">
                <h1 className="text-3xl font-bold mb-6 text-gray-800">My Loans</h1>
                <div className="mb-6 p-4 bg-gray-50 rounded-lg shadow-inner">
                    <h2 className="text-xl font-semibold mb-4 text-gray-700">Filter My Loans</h2>
                            ...
                            {loans.map((loan) => (
                                <tr key={loan.id}>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-left text-sm font-medium">
                                        <Link href={`/client/loans/${loan.id}`} className="text-blue-600 hover:text-blue-900 mr-4">View</Link>
                                        {/* No edit/delete for client side on this view */}
                                    </td>
                                </tr>
                            ))}
                        </tbody>
