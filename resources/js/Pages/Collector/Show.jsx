    ...
    return (
        <CollectorDashboardLayout>
            <div className="p-6 bg-white rounded-lg shadow-md">
                <h1 className="text-3xl font-bold mb-6 text-gray-800">Loan Details: {loan.marketing_id}</h1>
                ...
                <div className="flex items-center justify-end gap-4 mt-6">
                    ...
                    <Link href={`/collector/loans/${loan.id}/record-payment`} className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                        Record Payment
                    </Link>
                </div>
            </div>
...
export default CollectorLoanShow;
